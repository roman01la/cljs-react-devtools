...
var i_31133 = (self__.level + (1));
while(true){
if((i_31133 <= (new_level + (1)))){
(update[i_31133] = self__.header);

var G__31153 = (i_31133 + (1));
i_31133 = G__31153;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_31170 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_31170[i]));
} else {
x__$2.forward.push((((i < links_31170.length))?(links_31170[i]):null));
}

if((i < links_31170.length)){
(links_31170[i] = x__$2);
} else {
links_31170.push(x__$2);
}
...
var i_31185 = (0);
while(true){
if((i_31185 <= self__.level)){
var links_31188 = (update[i_31185]).forward;
if((x__$1 === (((i_31185 < links_31188.length))?(links_31188[i_31185]):null))){
(links_31188[i_31185] = (x__$1.forward[i_31185]));

var G__31200 = (i_31185 + (1));
i_31185 = G__31200;
continue;
} else {
var G__31201 = (i_31185 + (1));
i_31185 = G__31201;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__31235 = nx;
var G__31236 = (level__$1 - (1));
x = G__31235;
level__$1 = G__31236;
continue;
} else {
var G__31237 = x;
var G__31238 = (level__$1 - (1));
x = G__31237;
level__$1 = G__31238;
continue;
}
