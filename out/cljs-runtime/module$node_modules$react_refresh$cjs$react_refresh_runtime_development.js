shadow$provide.module$node_modules$react_refresh$cjs$react_refresh_runtime_development = function(global, require, module, exports) {
  (function() {
      ...
      if (hook.isDisabled) {
        ...
        hook.onCommitFiberRoot = function(id, root, maybePriorityLevel, didError) {
          ...
          if (void 0 !== helpers) {
            ...
            null !== alternate ? (alternate = null != alternate.memoizedState && null != alternate.memoizedState.element && mountedRoots.has(root), helpers = null != helpers.memoizedState && null != helpers.memoizedState.element, !alternate && helpers ? (mountedRoots.add(root), failedRoots.delete(root)) : alternate && helpers || (alternate && !helpers ? (mountedRoots.delete(root), didError ? failedRoots.add(root) : helpersByRoot.delete(root)) : alternate || helpers || didError && failedRoots.add(root))) : 
    ...
    exports.performReactRefresh = function() {
      if (0 === pendingUpdates.length || isPerformingRefresh) {
        return null;
      }
