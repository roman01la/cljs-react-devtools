...
return [(function (){var pred__40185 = cljs.core.instance_QMARK_;
var expr__40186 = reactive_val;
if(cljs.core.truth_((pred__40185.cljs$core$IFn$_invoke$arity$2 ? pred__40185.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__40186) : pred__40185.call(null, reagent.ratom.RAtom,expr__40186)))){
return "ra";
} else {
if(cljs.core.truth_((pred__40185.cljs$core$IFn$_invoke$arity$2 ? pred__40185.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__40186) : pred__40185.call(null, reagent.ratom.RCursor,expr__40186)))){
return "rc";
} else {
if(cljs.core.truth_((pred__40185.cljs$core$IFn$_invoke$arity$2 ? pred__40185.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__40186) : pred__40185.call(null, reagent.ratom.Reaction,expr__40186)))){
return "rx";
} else {
if(cljs.core.truth_((pred__40185.cljs$core$IFn$_invoke$arity$2 ? pred__40185.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__40186) : pred__40185.call(null, reagent.ratom.Track,expr__40186)))){
return "tr";
} else {
return "other";
}
