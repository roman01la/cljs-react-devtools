...
var G__39850 = o;
reagent.impl.template.goog$module$goog$object.set(G__39850,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
return (function() { 
var G__39918__delegate = function (args){
...
while (G__39919__i < G__39919__a.length) {G__39919__a[G__39919__i] = arguments[G__39919__i + 0]; ++G__39919__i;}
  args = new cljs.core.IndexedSeq(G__39919__a,0,null);
} 
return G__39918__delegate.call(this,args);};
G__39918.cljs$lang$maxFixedArity = 0;
G__39918.cljs$lang$applyTo = (function (arglist__39920){
var args = cljs.core.seq(arglist__39920);
return G__39918__delegate(args);
});
...
var G__39859 = o;
reagent.impl.template.goog$module$goog$object.set(G__39859,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__39923__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__39923 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__39924__i = 0, G__39924__a = new Array(arguments.length -  0);
while (G__39924__i < G__39924__a.length) {G__39924__a[G__39924__i] = arguments[G__39924__i + 0]; ++G__39924__i;}
  args = new cljs.core.IndexedSeq(G__39924__a,0,null);
} 
return G__39923__delegate.call(this,args);};
G__39923.cljs$lang$maxFixedArity = 0;
G__39923.cljs$lang$applyTo = (function (arglist__39925){
var args = cljs.core.seq(arglist__39925);
return G__39923__delegate(args);
});
...
var G__39866 = props;
var G__39866__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39866,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__39866);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39866__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__39868 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39868,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__39868;
}
})(),id_class);
...
var G__39876 = (cljs.core.count(argv) - first_child);
switch (G__39876) {
case (0):
...
var vec__39877 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39877,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39877,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39877,(2),null);
...
var temp__5827__auto___39932 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___39932 == null)){
} else {
var key_39933 = temp__5827__auto___39932;
(jsprops.key = key_39933);
}
...
var temp__5827__auto___39936 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___39936 == null)){
} else {
var key_39937 = temp__5827__auto___39936;
(jsprops.key = key_39937);
}
...
var temp__5827__auto___39940 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5827__auto___39940 == null)){
} else {
var key_39942 = temp__5827__auto___39940;
(jsprops.key = key_39942);
}
...
var temp__5827__auto___39946 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___39946 == null)){
} else {
var key_39947 = temp__5827__auto___39946;
(jsprops.key = key_39947);
}
...
var temp__5827__auto___39951 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___39951 == null)){
} else {
var key_39952 = temp__5827__auto___39951;
(jsprops.key = key_39952);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__39888_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__39888_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__39889 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39889,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39889,(1),null);
...
var G__39897 = tag;
var G__39897__$1 = (((G__39897 instanceof cljs.core.Keyword))?G__39897.fqn:null);
switch (G__39897__$1) {
case ">":
...
*/
reagent.impl.template.t_reagent$impl$template39905 = (function (opts,id,fn_to_element,parse_fn,meta39906){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template39905.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_39907,meta39906__$1){
var self__ = this;
var _39907__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template39905(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta39906__$1));
}));

(reagent.impl.template.t_reagent$impl$template39905.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_39907){
var self__ = this;
var _39907__$1 = this;
return self__.meta39906;
}));

(reagent.impl.template.t_reagent$impl$template39905.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template39905.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template39905.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template39905.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template39905.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template39905.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta39906","meta39906",1632292978,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template39905.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template39905.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template39905");

(reagent.impl.template.t_reagent$impl$template39905.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template39905");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template39905.
 */
reagent.impl.template.__GT_t_reagent$impl$template39905 = (function reagent$impl$template$__GT_t_reagent$impl$template39905(opts,id,fn_to_element,parse_fn,meta39906){
return (new reagent.impl.template.t_reagent$impl$template39905(opts,id,fn_to_element,parse_fn,meta39906));
});
...
return (new reagent.impl.template.t_reagent$impl$template39905(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
